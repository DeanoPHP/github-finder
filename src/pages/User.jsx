...
function User() {
    ...
    return <>
        <div className="w-full mx-auto lg:w-10 lg:w-10/12">
            <div className="mb-4">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 lg:grin-cols-3 md:grid-cols-3 mb-8 md:gap-8">
            ...
            <div className="w-full py-5 mb-6 rounded-lg shaddow-md bg-base-100 stats">
                <div className="stat">
